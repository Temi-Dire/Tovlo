...
const Faq = () => {
  ...
  return (
    <section className="">
        ...
        <div className="my-10">
            {faqs.map(() => 
            <div className="grid grid-cols-[auto_596px_auto]    px-10 py-5 border-y-2 border-primary ">
                <div className="flex items-star">
                    <p className="text-[32px] m-0 font-playfair">01</p>
                </div>
                <div>
                    <h2 className="font-medium italic text-[32px] font-playfair">Why should I feed my dog natural food</h2>
                ...
                <div className="flex justify-end h-fit">
                    <div className={`bg-[#D5E9D7] p-2 rounded-full cursor-pointer border-2 border-primary`} onClick={() => setShow()}>
